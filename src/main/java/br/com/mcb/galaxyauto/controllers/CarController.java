...
public class CarController {
	...
	@PostMapping
	public ResponseEntity<CarEntity> saveCar(@Valid @RequestBody CarCreateUpdateDto carDto) {
		CarEntity carEntity = carService.save(carDto);
		return ResponseEntity.ok().body(carEntity);
	}
	
	@PutMapping("/{carId}")
	public ResponseEntity<CarEntity> updateCar(@PathVariable UUID carId, @Valid @RequestBody CarCreateUpdateDto carDto) {
